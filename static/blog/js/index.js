function yuborish(){
    console.log("Sizdan uzur so'raymiz! Ushbu sayt test rejimida ishlayotganligi sababli xabaringizni vaqtincha yuborib bo'lmaydi!")
}
// let text = document.getElementsByClassName('text')
// let v1 = document.getElementsByClassName('a')

// for( i=0; i<v1.length; i++){
//     v1[i].onclick = function(){
